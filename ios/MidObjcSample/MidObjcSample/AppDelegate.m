...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[MidtransConfig shared]setClientKey:@"VT-client-yrHf-c8Sxr-ck8tx" environment:MidtransServerEnvironmentSandbox merchantServerURL:@"https://promo-engine-sample-server.herokuapp.com/"];
